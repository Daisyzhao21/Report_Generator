...
cd /Users/daisy/Documents/DaisyAI_Project/Report_Generator
...
class DailyReportGenerator:
    ...
    def generate(self, raw_text: str, report_type: str = "daily"):
        if not raw_text or len(raw_text.strip()) < 5:
            return {"success": False, "error": "输入内容太短", "report": None}
...
echo ""
echo "前10行:"
head -10 app.pyst.markdown("<p style='text-align:center;color:gray'>📱 手机/电脑自适应 | 数据不上传</p>", unsafe_allow_html=True)
